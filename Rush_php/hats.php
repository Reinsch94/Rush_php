...
<div class="card mb-3">
  <img class="card-img-top" src="gucci_bob.jpg" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">Gucci bob</h5>
    <p class="card-text">Vas-y suce mon flow, vas-y suce mon bob. Vas-y suce mon équipe.</p>
