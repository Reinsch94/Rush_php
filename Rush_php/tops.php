...
<div class="card mb-3">
  <img class="card-img-top" src="gucci_jacket.jpg" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">Gucci jacket</h5>
    <p class="card-text">This jacket by Gucci is made in a metallic pink leather with the designer's signature green and red Web collar. The woolly cuffs and hem will ensure girls are warm, and the luxurious red lining is designed with silkscreened bees and stars.</p>
    <p class="card-text"><small class="text-muted">1 500€</small></p>
  </div>
</div>
