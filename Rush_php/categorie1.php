  ...
  <div class="col-sm-6">
    <div class="card text-center">
      <div class="card-body">
        ...
        <a href="shoes.php" class="btn btn-primary">Shop me</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card text-center">
      <div class="card-body">
        <img src="images.jpeg" alt="product">
        <h5 class="card-title" align="center"><br>Tops</h5>
        <p class="card-text" align="center">Another awesome product made in Gucci gang's team</p>
        <a href="tops.php" class="btn btn-primary">Shop me</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card text-center">
      <div class="card-body">
        <img src="images.jpeg" alt="product">
        <h5 class="card-title" align="center"><br>Jeans</h5>
        <p class="card-text" align="center">Another awesome product made in Gucci gang's team</p>
        <a href="jeans.php" class="btn btn-primary">Shop me</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card text-center">
      <div class="card-body">
        <img src="images.jpeg" alt="product">
        <h5 class="card-title" align="center"><br>Hats</h5>
        <p class="card-text" align="center">Another awesome product made in Gucci gang's team</p>
        <a href="hats.php" class="btn btn-primary">Shop me</a>
      </div>
    </div>
  </div>
</div>
