...
<div class="card mb-3">
  <img class="card-img-top" src="gucci_pants.jpg" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">Gucci jeans</h5>
    <p class="card-text">Wiredest jeans ever made by Gucci. A muste have !</p>
    <p class="card-text"><small class="text-muted">1 600€</small></p>
  </div>
</div>
